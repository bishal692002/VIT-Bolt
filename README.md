...
=======
# VITato 🍔# VITato (Prototype)



**Campus-exclusive food delivery platform for VIT Bhopal** with enterprise-grade admin panel.Campus‑exclusive food delivery for VIT Bhopal.
...
npm run seed:vendor-users  # Create vendor users
```
